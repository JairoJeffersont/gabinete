...
if ($buscaTipo['status'] == 'not_found' || is_integer($tipoGet) || $buscaTipo['status'] == 'error') {
    header('Location: ?secao=clipping-tipos');
}
        ...
        <div class="container-fluid p-2">
            <div class="card mb-2 ">
                <div class="card-body p-1">
                    ...
                    <a class="btn btn-success btn-sm custom-nav card-description" href="?secao=clipping-tipos" role="button"><i class="bi bi-arrow-left"></i> Voltar</a>
                </div>
            </div>
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-file-earmark-text-fill"></i> Editar Tipo de Clipping</div>
                <div class="card-body p-2">
                    <p class="card-text mb-2">Nesta seção, é possível editar os tipos de clipping, garantindo a organização correta dessas informações no sistema.</p>
            ...
            <div class="card shadow-sm mb-2">
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_atualizar'])) {
                        ...
                        $result = $clippingTipoController->atualizarClippingTipo($tipoGet, $dados);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="clipping_tipo_nome" placeholder="Nome do Tipo" value="<?php echo $buscaTipo['dados'][0]['clipping_tipo_nome'] ?>" required>
                        </div>
                        <div class="col-md-4 col-12">
                            <input type="text" class="form-control form-control-sm" name="clipping_tipo_descricao" placeholder="Descrição" value="<?php echo $buscaTipo['dados'][0]['clipping_tipo_descricao'] ?>" required>
                        </div>
                        <div class="col-md-4 col-12">
