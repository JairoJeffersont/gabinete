    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2 card-description">
                <div class="card-header bg-primary text-white px-2 py-1 card-background"><i class="bi bi-file-earmark-text-fill"></i> Adicionar Tipo de Clipping</div>
                ...
                <div class="card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-striped mb-0 custom-table">
                            ...
                            <tbody>
                                <?php
                                $busca = $clippingTipoController->listarClippingTipos();
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $clippingTipo) {
                                        echo '<tr>';
                                        echo '<td style="white-space: nowrap;"><a href="?secao=clipping-tipo&id=' . $clippingTipo['clipping_tipo_id'] . '">' . $clippingTipo['clipping_tipo_nome'] . '</a></td>';
