                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        $cliente = [
                            ...
                            'cliente_cpf_cnpj' => htmlspecialchars($_POST['cliente_cpf_cnpj'], ENT_QUOTES, 'UTF-8'),
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="cliente_cpf_cnpj" placeholder="CPF ou CNPJ" required>
                        </div>
                        <div class="col-md-2 col-12">
